...
#Middle row
makebox(i.elpos = 2, lab. = "Inference")
makebox(i.elpos = 3, lab. = "Prediction")
makebox(i.elpos = 4, lab. = "Model\nselection")

#Bottom row
makebox(i.elpos = 5, lab. = "*Hypothesis testing\n*Ho vs. Ha", lcol. = 0, pos. = NULL)
makebox(i.elpos = 6, lab. = "*Predict y\nfor unknown\nindividual", lcol. = 0, pos. = NULL)

makebox(i.elpos = 7, lab. = "*Which of\nmultiple predictors\nbest explains\ndata?", lcol. = 0, pos. = NULL)